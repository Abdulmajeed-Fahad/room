...
.alert-banner {
    background: linear-gradient(135deg, var(--security-bg), #e0f2fe);
...
[data-theme="dark"] .alert-banner {
    background: linear-gradient(135deg, var(--security-bg), #1e3a8a);
...
.mode-toggle-card.security-mode {
    border-color: var(--security-primary);
    background: linear-gradient(135deg, var(--security-bg), #e0f2fe);
    box-shadow: 0 0 20px rgba(99, 102, 241, 0.2);
}

[data-theme="dark"] .mode-toggle-card.security-mode {
    background: linear-gradient(135deg, var(--security-bg), #1e3a8a);
}
...
.mode-btn.security-active {
    background: linear-gradient(135deg, var(--security-primary), #4f46e5);
    color: white;
    border-color: var(--security-primary);
...
[data-theme="dark"] .sensor-card.normal {
...
[data-theme="dark"] .sensor-card.danger {
    background: linear-gradient(135deg, #7f1d1d, #991b1b);
}

[data-theme="dark"] .sensor-card.offline {
...
[data-theme="dark"] .last-reading-info {
...
[dir="ltr"] .event-item:hover,
[dir="ltr"] .alert-item:hover {
    transform: translateX(-4px);
}
